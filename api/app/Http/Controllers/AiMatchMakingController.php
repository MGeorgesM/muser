...
class AiMatchMakingController extends Controller
{
    ...
    public function getMatch(Request $request)
    {
        ...
        $currect_user_instrument = auth()->user()->instrument->pluck('name')->toArray();
        ...
        try {
            $result = $client->chat()->create([
                ...
                'messages' => [
                    ...
                    ['role' => 'system', 'content' => 'Return JSON format of the music genres found, the closest 3 location.'],
